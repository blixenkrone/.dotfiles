# Generated by Powerlevel10k configuration wizard on 2024-05-03 at 17:43 CEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_BACKGROUND='#3f639e'
  ...
  function my_git_formatter() {
    ...
    # See POWERLEVEL9K_2VCS_UNTRACKED_ICON above if you want to use a different icon.
